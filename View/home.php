...
$question = '123 exercitationem quidem illo exercitationem quidem  ';
...
<body class='lightbulb-home-search-body' style='min-height:300px'>
    ...
    <div class="lightbulb-home-chat-design-splash-screen">
        <div class="splash-screen-logo-cont">
            <div class="l-c-d-logo">   
            </div>
            <div class="l-c-d-name">
                Lightbulb   
            </div>
...
if (isset($_GET['search'])) {
    ...
    foreach ($questions as $question) {
        $question_count++;?>
                            <div class='question-bubble-cont question-bubble-cont<?php echo $question_count; ?>'>
                                <script>
                                ...
                                <div id='manage-bubble<?php echo $question_count; ?>'
                                    ...
                                    <div class='name-and-pic-cont'>
                                    <!-- <div class=''> </div> -->
                                    <div class='search-question-name'>User name's Question</div>
                                ...
                                <div class='search-answer-pic search-answer-pic-left'></div>
                            </div>
            ...
            $answer_count++;?>
                            ...
                            <div class='search-answer-pic'></div>
                                <div id='manage-bubble' class='answer-bubble manage-bubble'>
                                    <div class='name-and-pic-cont'>
                                        <!-- <div class='search-answer-pic'></div> -->
                                        <div class='search-answer-name'>user name's Answer</div>
                                        <div class='search-answer-img'></div>
                                        <div class='search-answer-cfg-img'></div>
                                    </div>
                                    ...
                                    <!-- hide references cont open-->
                                    <div class="hide-references-cont">
...
if ($reference['source_type'] == $document) {; //test code
                ...
                ?>
                                    ...
                                    <?php
if ($reference['source_type'] == $journal) {
                    ; //test code
                    ?>
                                    <div class='reference-list-cont'>
                                        <div class='search-clipboard apa-citation apa-citation<?php echo $references_count; ?>'
...
if ($reference['https_doi']) {
                ...
                ?>
                                    ...
                                    <!-- hide references close -->
                                    </div>
                                    <!-- ------------ -->
                                    <div class='likes-and-emojis'>
                                        <div class='likes-and-emojis-btns likes-btn'
                                            onclick="like('<?php echo $question_count; ?>')" style="width:50px;">
                                        ...
                                        <div class='likes-and-emojis-btns icon-splitter'></div>
...
?>
                            ...
                            <div class="no-matches-found-cont-wrapper">
                ...
                <!-- fix -->
                    <form id="search-form" method="post">
                        <div class='search-input-cont-placeholder search-input-cont-placeholder-home-chat-design'>
